...
<div class="header">
    <div class="container">
        ...
        <div class="w3l_sign_in_register">
            <ul>
                <li><i class="fa fa-phone" aria-hidden="true"></i> (+000) 151 8983 3205</li>
            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <nav>
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="${pageContext.request.contextPath}/pages/main.jsp">主页</a></li>
                        <li class="dropdown">
    ...
    <div class="container">
        <div class="w3ls_footer_grid">
            ...
            <div class="col-md-6 w3ls_footer_grid_right">
                <a><h2>One<span>Movies</span></h2></a>
            </div>
            <div class="clearfix"> </div>
        </div>
